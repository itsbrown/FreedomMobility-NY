...
describe('pay form Formspree payload', () => {
  ...
  it('sends timesheet + recaptcha token and does not rely on _cc for delivery', () => {
    const payload = buildPayFormPayload({
      ...
      name: 'Test Tech',
      week: '2026-08-22',
      timesheet: 'Freedom Mobility NY — Weekly Pay Form\nSend to: brian.parmele@freedommobilityva.com',
      installationTotal: '175.00',
      mileageTotal: '0.00',
      grandTotal: '175.00',
      billableMiles: '0.0',
      recipient: 'brian.parmele@freedommobilityva.com',
    ...
    assert.equal(payload.intendedRecipient, 'brian.parmele@freedommobilityva.com');
